...
const IS_UNCHANGED = Symbol("Is Unchanged");

function makeDiff(before, after, location = "") {
    if (_.isArray(after))
...
function makeDiffArray(before, after, location = "") {
...
function makeDiffObject(before, after, location = "") {
...
function makeDiffScalar(before, after) {
    return before !== after ? after : IS_UNCHANGED;
}

function mergeDiff(base, diff, location = "") {
    if (diff == null)
        return null;
